...
if(dropdown2.value()== "Personal actions - On Days when High Particle Levels are Expected" ){
	var text1=createP('Reduce the number of trips you take in your car. \nReduce or eliminate fireplace and wood stove use.\nAvoid burning leaves, trash, and other materials.\nAvoid using gas-powered lawn and garden equipment.')
text1.position(450,230)
text1.style('font-size', '18px');
text1.style('color', '#ff0000');
text1.style('font','Arial Rounded MT Bold')
